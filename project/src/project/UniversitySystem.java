...
public class UniversitySystem {
    ...
    private static final String[] TELECOM_SUBJECTS = {
    	    "1. BPC-ARS / Architektura sítí",
    	    "2. BPC-DAK / Datová komunikace",
    	    "3. BPC-DE1 / Digitální elektronika 1",
    	    "4. BPC-PC2T / Počítače a programování 2"
    	};

    	private static final String[] CYBER_SUBJECTS = {
    	    "1. BPC-AKR / Aplikovaná kryptografie",
    	    "2. BPC-DMA / Diskrétní matematika",
    	    "3. BPC-MA2 / Matematika 2",
    	    "4. BPC-PC2T / Počítače a programování 2",
    	    "5. BPC-UP1A / Úvod do práva ICT 1"
    	};
    	...
    	private static void addGrade() {
    	    try {
    	        ...
    	        String[] subjects = student instanceof TelecomStudent ? 
    	            TELECOM_SUBJECTS : CYBER_SUBJECTS;
    	        
    	        System.out.println("\nSubjects for " + student.getFirstName() + " " + student.getLastName() + ":");
    	        for (String subject : subjects) {
    	            System.out.println(subject);
    	        }
    	        
    	        while (true) {
    	            System.out.print("\nEnter subject number (1-" + subjects.length + ") or 0 to finish: ");
    	            int subjectChoice;
    	            try {
    	                ...
    	                System.out.print("Enter grades for " + subjects[subjectChoice-1].substring(3) + " (1-5, separate with commas): ");
